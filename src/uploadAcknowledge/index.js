...
<LinearGradient colors={['#ED3D68', '#ED3A4E', '#ED3D39', '#EE5235']}
                    ...
                    <Text style={{ fontFamily: 'LibreFranklin-Bold', fontSize:17,alignSelf:'center',textAlign:'center',color:'#105BE4'}}>Need help selecting a device? Schedule an appointment with one of our providers</Text>
