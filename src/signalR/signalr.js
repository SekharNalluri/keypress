...
(function ($, window, undefined) {
  ...
  signalR.fn = signalR.prototype = {
    init: function (url, qs, logging) {
      ...
      this._ = {
        ...
        connectingMessageBuffer: new ConnectingMessageBuffer(this, function (
          ...
          console.log('connectingMessageBuffer', message);
    ...
    start: function (options, callback) {
      ...
      // }
      connection.protocol = connection.url.substr(
        0,
        connection.url.indexOf('//'),
      );
    ...
    receive: function (connection, data) {
      ...
      if (connection.state === $.signalR.connectionState.connected) {
        ...
        if (
          ...
          cw =
            connection.frame.contentWindow || connection.frame.contentDocument;
...
(function ($, window, undefined) {
  ...
  hubProxy.fn = hubProxy.prototype = {
    ...
    on: function (eventName, callback) {
      ...
      console.log('callbackMap', eventName, callback);
      callbackMap[eventName][callback] = function (e, data) {
        console.log('callbackMap[eventName][callback]()');
        callback.apply(that, data);
      };
      console.log('eventName', makeEventName(eventName));
  ...
  hubConnection.fn.init = function (url, options) {
    ...
    connection.received(function (minData) {
      console.log('connection.received', minData);
